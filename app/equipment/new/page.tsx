...
export default function NewEquipmentPage() {
  ...
  // Fetch categories and rooms for dropdowns
  useEffect(() => {
  ...
  const onSubmit = async (data: EquipmentFormValues) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(responseData.error || "Помилка при створенні запису");
      }
      ...
      setError(err.message || "Сталася помилка при створенні запису");
    } finally {
  ...
  return (
    <div className="py-6">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-2xl font-bold">Додати нову техніку</h1>
        <Link
          href="/equipment"
